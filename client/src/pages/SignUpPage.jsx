...
const SignUpPage = () => {
  return (
    ...
    >
      <div
        className="w-full bg-glass rounded-lg shadow md:mt-0
      sm:max-w-md xl:p-0"
      >
        <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
          ...
          <button
            ...
            focus:ring-4 focus-ring-[#24292f]/50 font-medium flex gap-2 p-2
            items-center justify-center w-full text-center rounded-md"
          >
